      ...
      <div className="flex flex-col md:flex-row flex-wrap justify-between gap-10 w-full">
        ...
        <div className="flex-1 min-w-[250px]">
          ...
          <p className="text-base sm:text-lg mb-2 leading-relaxed">
            If you have any queries regarding our society, or would like to
            reach out to us about our events, please send us an email at:{" "}
          ...
          <div className="pl-0">
            ...
            <p className="text-base sm:text-lg">
              2025 IEEE VSSUT Student Branch
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 min-w-[250px]">
          ...
          <div className="flex flex-col gap-2 text-base sm:text-lg">
            <a
              ...
              className="hover:text-blue-600 focus:text-blue-600 active:text-blue-700"
            >
              IEEE.org
            </a>
            <a
          ...
          <div className="flex gap-4 text-xl">
            <Link
              ...
              className="hover:text-blue-700 focus-within:text-blue-700"
            >
              <FaFacebookF />
            </Link>
            <Link
              href="https://www.instagram.com/ieeevssut/"
              className="hover:text-pink-500 focus-within:text-pink-500"
            >
              <BsInstagram />
            </Link>
            <Link
              href="https://twitter.com/ieee_vssut_sb"
